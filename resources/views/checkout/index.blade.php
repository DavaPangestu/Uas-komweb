            ...
            @foreach ($cart as $item)
                <div class="cart-item">
                    ...
                    <div class="cart-item-price">
                        Rp{{ number_format($item['modified_price'] * $item['quantity'], 0, ',', '.') }}
                    </div>
                </div>
            @endforeach
            ...
            <form action="{{ route('payment.process') }}" method="POST" id="checkout-form">
                ...
                <div class="payment-options">
                    <div class="payment-option">
                        ...
                        <img src="{{ asset('images/ovo.jpg') }}" alt="Ovo" class="payment-image">
                    </div>
                    <div class="payment-option">
                        <input type="radio" id="Gopay" name="payment_method" value="Gopay">
                        <label for="Gopay">Gopay</label>
                        <img src="{{ asset('images/gopay.png') }}" alt="Gopay" class="payment-image">
                    </div>
                    <div class="payment-option">
                        <input type="radio" id="Qris" name="payment_method" value="Qris">
                        <label for="Qris">Qris</label>
                        <img src="{{ asset('images/Qris.jpg') }}" alt="Qris" class="payment-image">
                    </div>
                </div>
                ...
                <div id="qris-popout" class="popout">
                    ...
                    <div class="qris-image-container">
                        <img src="{{ asset('images/Isiqrisloh.jpg') }}" alt="QRIS">
                    </div>
                </div>
