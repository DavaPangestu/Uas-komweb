...
<head>
    ...
    <title>Detail - <?php echo e($product->name); ?></title>
    <style>
        body {
...
<body>
    ...
    <img class="product-image" src="<?php echo e(asset('images/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>">
        <div class="product-info">
            <h2><?php echo e($product->name); ?></h2>
            <p class="price" id="total-price" data-base-price="<?php echo e($product->price); ?>">
            ...
            <div class="option-group">
                ...
                <div class="options">
                    <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="size-btn" data-price="<?php echo e($size['price']); ?>" data-name="<?php echo e($size['name']); ?>">
            ...
            <div class="option-group">
                <p>Ice:</p>
                <div class="options">
                    <?php $__currentLoopData = $iceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="ice-btn" data-value="<?php echo e($ice); ?>"><?php echo e($ice); ?></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="option-group">
                <p>Sugar:</p>
                <div class="options">
                    <?php $__currentLoopData = $sugarFlavors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sugar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="sugar-btn" data-value="<?php echo e($sugar); ?>"><?php echo e($sugar); ?></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                ...
                <input type="hidden" name="price" id="modified-price" value="<?php echo e($product->price); ?>">
...
<?php /**PATH C:\laragon\www\semogaWebHambaBisaYaallah\resources\views/menu/detail.blade.php ENDPATH**/ ?>