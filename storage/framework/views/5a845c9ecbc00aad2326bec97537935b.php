    ...
    <div class="container">
        <nav class="navbar">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('menu.index', ['category' => $cat])); ?>"
                    class="<?php echo e($category === $cat ? 'active' : ''); ?>">
                    <?php echo e($cat); ?>
                    ...
                    <div class="buttons">
                        ...
                        <?php if($isInCart): ?>
                            <div class="quantity-container">
                                <form method="POST" action="<?php echo e(route('cart.update', $product->id)); ?>" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="action" value="decrease">
                                    <button type="submit" class="quantity-btn minus-btn">-</button>
                                </form>

                                <span class="quantity-display"><?php echo e($quantity); ?></span>
                        ...
                        <a href="<?php echo e(route('menu.detail', $product->id)); ?>" class="details-button">Details</a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </main>
        ...
        <div class="cart-section">
            ...
            <?php if(!empty($cart)): ?>
                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="cart-item">
                        ...
                        <div>
                            ...
                            Size: <?php echo e($item['size'] ?? 'Regular'); ?><br>
                            Ice: <?php echo e($item['ice'] ?? 'Normal Ice'); ?><br>
                            Sugar: <?php echo e($item['sugar'] ?? 'Normal Sweet'); ?><br>
                            Quantity: <?php echo e($item['quantity']); ?><br>
                            Total: Rp<?php echo e(number_format($item['price'] * $item['quantity'], 0, ',', '.')); ?>
                ...
                <div class="cart-total">
                    <strong>Total: Rp<?php echo e(number_format($total, 0, ',', '.')); ?></strong>
                </div>

                <form action="<?php echo e(route('checkout.show')); ?>" method="GET">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\semogaWebHambaBisaYaallah\resources\views/menu/index.blade.php ENDPATH**/ ?>